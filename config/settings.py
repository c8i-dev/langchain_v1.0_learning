...
class Settings(BaseSettings):
    ...
    gemini_base_url: str = Field(alias="GEMINI_BASE_URL")
    gemini_model: str = Field(alias="GEMINI_MODEL")
    gemini_provider: str = Field(alias="GEMINI_PROVIDER")

    # minimax
    minimax_model: str = Field(alias="MINIMAX_MODEL")
    minimax_model_provider: str = Field(alias="MINIMAX_PROVIDER")
    minimax_api_key: str = Field(alias="MINIMAX_API_KEY")
    minimax_base_url: str = Field(alias="MINIMAX_BASE_URL")

    # huanyuan
    huanyuan_model: str = Field(alias="HUANYUAN_MODEL")
    huanyuan_model_provider: str = Field(alias="HUANYUAN_PROVIDER")
    huanyuan_api_key: str = Field(alias="HUANYUAN_API_KEY")
    huanyuan_base_url: str = Field(alias="HUANYUAN_BASE_URL")
